...
class Add(Tk):
    def __init__(self):
        ...
        self.title('Adding Book')
        self.canvas = Canvas(width=500, height=500, bg='light blue')
        self.canvas.pack()
        a = StringVar()
        b = StringVar()
        c = StringVar()
        ...
        Label(self, text='Book Details:',fg='black',font=('Times new Roman', 20, 'bold')).place(x=150, y=70)
        Label(self, text='').pack()
        Label(self, text='Book Name:',fg='black', font=('Times new Roman', 10, 'bold')).place(x=60, y=180)
        Entry(self, textvariable=b, width=30).place(x=170, y=182)
        Label(self, text='Book Author:',fg='black', font=('Times new Roman', 10, 'bold')).place(x=60, y=230)
        Entry(self, textvariable=c, width=30).place(x=170, y=232)
        Button(self, text="Submit", command=b_q).place(x=225, y=300)
Add().mainloop()