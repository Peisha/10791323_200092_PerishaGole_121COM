...
#label and input box
        Label(self, text='Book Issuing', font=('Times new Roman', 24)).place(x=135, y=40)
        Label(self, text='Book ID:', font=('Times new Roman', 15), fg='black').place(x=20, y=100)
        Entry(self, textvariable=c, width=40).place(x=160, y=106)
        Label(self, text='Student ID:', font=('Times new Roman', 15), fg='black').place(x=20, y=150)
        Entry(self, textvariable=d, width=40).place(x=160, y=158)
        Button(self, text="ISSUE", width=20, command=isb).place(x=150, y=200)
issue().mainloop()
